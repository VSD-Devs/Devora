    ...
    <section className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-32 md:pt-40 relative z-[30]">
        <div className="max-w-4xl mx-auto text-center">
          <div>
            <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-[1.2] bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-100 drop-shadow-[0_2px_2px_rgba(0,0,0,0.5)]">
              Design. Build. Scale.
            </h1>
