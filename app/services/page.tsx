...
export default function ServicesPage() {
  return (
    <>
      ...
      />
      <main className="min-h-[100dvh] flex flex-col bg-gradient-to-b from-gray-50 to-gray-100">
        <div className="relative z-[2] flex-1 flex flex-col">
          {/* Content wrapper - Added to ensure content stays above background */}
          <div className="container mx-auto px-4 sm:px-6 relative z-[30] flex-1 flex flex-col pt-32 md:pt-32">
            {/* Hero Section */}
                ...
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="md:hidden text-center mb-8">
                    ...
                    <p className="text-base text-gray-600">
                      High-performance websites and applications that help startups scale
                    </p>
                  </div>

                  {/* Desktop Title */}
                  <h1 className="hidden md:block text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 md:mb-8 leading-[1.2] bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 py-1">
                    Turn Your Vision Into Reality
                  </h1>
                  <p className="hidden md:block text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed">
